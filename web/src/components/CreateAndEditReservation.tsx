...
const CreateAndEditReservation: React.FC<Props> = ({
  ...
  return (
    <FormContainer>
        ...
        <h1>{isUpdateMethod ? "Edit" : "Add new"} reservation</h1>
          ...
          <SubmitButton isUpdateMethod 
            disabled={fieldErrors.name !== "" || fieldErrors.numberOfGuests !== "" 
            || fieldErrors.dateAndTime !== "" || fieldErrors.email !== ""
            || reservation.name === "" || reservation.numberOfGuests === ""
            || reservation.dateAndTime === null}
            onClick={(e) => {{isUpdateMethod ? editReservation(e) : addNewReservation(e)}}}
          >
